...
**Hugo Pedro** — Data Analyst with focus on maritime logistics and BI/Analytics. Repository intended as a public case study portfolio for container shipping lines, freight forwarders, port operators, and trade analysts evaluating Brazil commercial and operational strategy.

Background: 17+ years in international shipping including 7 years in Luanda (Angola) and 4 years in Mozambique. Currently completing MBA in Data Science & AI at FIAP, São Paulo.
